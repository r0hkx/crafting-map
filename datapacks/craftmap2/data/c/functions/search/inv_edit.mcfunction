...
execute as @a at @s run playsound speedrunigt:stop_practice master @s ~ ~ ~ 1 1 1
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.9968440532684326
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.9459357261657715
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.8609302043914795
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.976266860961914
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.8157604932785034
