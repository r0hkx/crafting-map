...
execute as @a at @s run playsound speedrunigt:stop_practice master @s ~ ~ ~ 1 1 1
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.8769466876983643
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.980252981185913
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.845943570137024
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.905091643333435
playsound minecraft:entity.item.pickup master @a ~ ~ ~ 0.20000000298023224 1.9053831100463867
