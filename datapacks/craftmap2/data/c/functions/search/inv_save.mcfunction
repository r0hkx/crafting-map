execute unless block -8 5 10 minecraft:yellow_shulker_box run setblock -8 5 10 minecraft:yellow_shulker_box
execute unless block -8 5 9 minecraft:yellow_shulker_box run setblock -8 5 9 minecraft:yellow_shulker_box
execute unless block -8 5 8 minecraft:yellow_shulker_box run setblock -8 5 8 minecraft:yellow_shulker_box
